...
int main(int argc, char *argv[])
{
	...
	main.setFixedSize (900, 40); // rozmiar okna 800x800
	...
	menu.setFixedSize(1000,40);
	
	// Tworzenie wykresu na konkretnym oknie
	QwtPlot wykres;
	QwtPlot wykres2;
	//main.setWykresy(&wykres, &wykres2, &okno);
	...
	menuLayout->addWidget(&main, 0, 0, Qt::AlignCenter);
	
	oknoLayout->addWidget(main.getButton(), 1, 0, Qt::AlignCenter);
	oknoLayout->addWidget(main.getButton2(), 1, 1, Qt::AlignCenter);
	oknoLayout->addWidget(main.getWykres1(), 0, 0, Qt::AlignCenter);
	oknoLayout->addWidget(main.getWykres2(), 0, 1, Qt::AlignCenter);
